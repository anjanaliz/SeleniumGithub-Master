...
//Login successful message
	   ...
	   // Assert.assertEquals(actualMessage, expectedMessage, "Actual message is not same as Expected URL");
		Assert.assertTrue(actualMessage.contains(expectedMessage), "Actaul message is not contained in expected message. /n Actual Message: "+ actualMessage + " /n Expected Message: "+ expectedMessage +"");
